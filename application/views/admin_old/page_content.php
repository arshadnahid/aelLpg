...
<!-- Home Content Here -->
									...
									<div class="col-md-3">
										...
										<a href="<?php echo base_url()?>new_distributor" class="radius-4">
											<img src="<?php echo base_url()?>assets/inc/dist.png" class="img-responsive">
										</a>
										<h4 class="httext">Distributor</h4>
                         ...
                         <div class="col-md-3">
										<a href="<?php echo base_url()?>set_offers" class="radius-4">
											<img src="<?php echo base_url()?>assets/inc/offer.png" class="img-responsive">
										</a>
										<h4 class="httext">Offers</h4>
