...
<button class="pull-right navbar-toggle navbar-toggle-img collapsed" type="button" data-toggle="collapse" data-target=".navbar-buttons,.navbar-menu">
						...
						<img src="<?php echo base_url()?>assets/inc/ael.png" alt="AEL's Photo" />
					</button>
...
<img class="nav-user-photo" src="<?php echo base_url()?>assets/inc/ael.png" alt="AEL's Photo" />
...
<span class="grey bigger-110">(0 unread messages)</span>
</div>
...
<div class="pull-left">messages total </div>
...
<form id="id-message-form" class="hide form-horizontal message-form col-xs-12" method="post" action="<?php echo base_url()?>Ael_panel/send_message" enctype="multipart/form-data">
<div>
...
<!-- <input type="email" name="recipient" id="form-field-recipient" data-value="info@ael.com" value="info@ael.com" placeholder="Recipient(s)" /> -->

<select name="dist_id"  id="form-field-recipient" class="chosen-select form-control" id="form-field-select-3" data-placeholder="Choose Users...">
					<option value="all">------All------</option>
					<?php 

					//$dist_info = $this->Admin_panel_model->select_all_view_dist();

					foreach($dist_info as $dist_info) {
						?>
...
<textarea id="editor11" rows="7" name="msg" style="margin-left: 0px; margin-right: 0px; width: 633px;"></textarea>
...
<i class="ace-icon fa fa-envelope bigger-140"></i>
Send
</button>
</div>
...
&nbsp;
<a href="#" class="sender">AEL</a>

&nbsp;
<i class="ace-icon fa fa-clock-o bigger-110 orange middle"></i>
<span class="time grey">Today, 4:45 pm</span>
</div>
