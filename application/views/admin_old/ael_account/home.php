		...
		<div id="navbar" class="navbar navbar-default          ace-save-state">
			<div class="navbar-container ace-save-state" id="navbar-container">
				...
				<div class="navbar-header pull-left">
					<a href="<?php echo base_url()?>Admin_account" class="navbar-brand">
						<small>
...
<li>
<a href="<?php echo base_url()?>Ael_admin">
		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<div id="sidebar" class="sidebar                  responsive                    ace-save-state">
				...
				<ul class="nav nav-list">
					<li class="">
						<a href="<?php echo base_url()?>Admin_account/coa">
					...
					<li class="">
						<a href="<?php echo base_url()?>Admin_account/coa_acc">
							<i class="menu-icon fa fa-eye"></i>
							<span class="menu-text">View Coa List</span>
						</a>
					...
					<li class="">
						<a href="<?php echo base_url()?>Admin_account/ledger">
					...
					<li class="">
						<a href="<?php echo base_url()?>Admin_account/ledger_acc">
							<i class="menu-icon fa fa-eye"></i>
					...
					<li class="">
						<a href="<?php echo base_url()?>Admin_account/trial_balance">
							<i class="menu-icon fa fa-eye"></i>
					...
					<li class="">
						<a href="<?php echo base_url()?>Admin_account/balance_sheet">
							<i class="menu-icon fa fa-eye"></i>
							<span class="menu-text"> BalanceSheet </span>
						</a>
					...
					<li class="">
						<a href="<?php echo base_url()?>Admin_account/income_st">
							<i class="menu-icon fa fa-eye"></i>
