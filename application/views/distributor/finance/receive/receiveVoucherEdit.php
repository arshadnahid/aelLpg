    ...
    <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            ...
            <ul class="breadcrumb pull-right">
                ...
                <li class="active financeAddPermission"><a href="<?php echo site_url('receiveVoucherAdd'); ?>" >
                        <i class="ace-icon 	fa fa-plus"></i>  Add
                    </a>
                </li>
                <li class="active"><a href="<?php echo site_url('receiveVoucherView/' . $receiveVoucher->generals_id); ?>" >
                    ...
                    <form id="publicForm" action=""  method="post" class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group">
                                        <input class="form-control date-picker" name="date" id="paymentDate" type="text" value="<?php echo date('d-m-Y', strtotime($receiveVoucher->date)); ?>" data-date-format="dd-mm-yyyy" />
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" id="form-field-1" name="voucherid" readonly value="<?php echo $receiveVoucher->voucher_no; ?>" class="form-control" placeholder="Voucher Id" />
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <select name="payType" onchange="selectPayType(this.value)" class="chosen-select form-control" id="payType" data-placeholder="Search by Receive">
                                        <option value=""></option>
                                        <option <?php
if ($receiveVoucher->payType == 1) {
    echo "selected";
}
?> value="1">Accounts</option>
                                        <option <?php
                                            if ($receiveVoucher->payType == 2) {
                                                echo "selected";
                                            }
?> value="2">Customer</option>
                                        <option <?php
                                            if ($receiveVoucher->payType == 3) {
                                                echo "selected";
                                            }
?> value="3">Supplier</option>
                                            ...
                                            <optgroup label="<?php echo $head['parentName']; ?>">
                                                ...
                                                foreach ($head['Accountledger'] as $eachLedger) :
                                                    if (($eachLedger->chartId == '54' && $eachLedger->parentId == '42') || $eachLedger->parentId == '55'):
                                                        ?>
                                                        <option <?php
                                            if ($getDebitAccountId == $eachLedger->chartId) {
                                                echo "selected";
                                            }
                            ...
                            <table class="table table-bordered table-hover" id="show_item">
                                ...
                                <tbody>
                                    ...
                                    foreach ($getCreditAccountId as $key => $eachAccount):
                                        $totalAmount+=$eachAccount->credit;
                                        $chartInfo = $this->Common_model->tableRow('chartofaccount', 'chart_id', $eachAccount->account);
                                        ?>
                                        <tr class="new_item<?php echo $key + 565; ?>">
                                            <td style="padding-left:15px;"><?php echo $chartInfo->title . ' [ ' . $chartInfo->accountCode . ' ]'; ?><input type="hidden" name="accountCr[]" value="<?php echo $eachAccount->account; ?>"></td>
                                            <td style="padding-left:15px;" align="right"><input class="amount form-control text-right" type="text" name="amountCr[]" value="<?php echo $eachAccount->credit; ?>"></td>
                                            <td align="right"><input type="text" class="add_quantity form-control text-right" name="memoCr[]" value="<?php echo $eachAccount->memo; ?>"></td>
                                            <td><a del_id="<?php echo $key + 565; ?>" class="delete_item btn form-control btn-danger" href="javascript:;" title=""><i class="fa fa-times"></i>&nbsp;Remove</a></td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                                <tfoot>
                                    ...
                                    <tr>
                                        ...
                                        <td align="right"><strong class="tttotal_amount"><?php echo $totalAmount . '.00'; ?></strong></td>
                        ...
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        <textarea cols="100" rows="2" name="narration" placeholder="Narration" type="text"><?php echo $receiveVoucher->narration; ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    $.ajax({
        type: 'POST',
        url: url,
        data:{'payid':<?php echo $receiveVoucher->payType; ?>,
            payUserId:'<?php
