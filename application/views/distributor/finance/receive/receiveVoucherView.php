        ...
        <div class="breadcrumbs ace-save-state noPrint" id="breadcrumbs">
            <ul class="breadcrumb">
                <li>
                    ...
                    <a href="#">Receive Voucher</a>
                </li>
                <li class="active">Receive Voucher View </li>
            </ul>
            <ul class="breadcrumb pull-right">
                <li>
                    <a title="Receive voucher listt" href="<?php echo site_url('receiveVoucher'); ?>">
                        <i class="ace-icon 	fa fa-list"></i> List
                    </a>
                </li>
                <li title="Receive voucher Add" class="active addPermission"><a href="<?php echo site_url('receiveVoucherAdd'); ?>" >
                        <i class="ace-icon 	fa fa-plus"></i>  Add

                    </a>
                </li>
                <li>
                    <a title="Receive voucher edit" class="financeEditPermission" href="<?php echo site_url('receiveVoucherEdit/' . $receiveVoucher->generals_id); ?>">
                    ...
                    <div class="widget-box transparent">
                        <div class="widget-header widget-header-large">
                            ...
                            <div class="widget-toolbar no-border invoice-info">
                                ...
                                <span class="red"><?php echo $receiveVoucher->voucher_no; ?></span>
                                <br />
                                <span class="invoice-info-label">Date:</span>
                                <span class="blue"><?php echo date('Y-m-d', strtotime($receiveVoucher->date)); ?></span>
                            </div>
                                    ...
                                    <div class="col-xs-6">
                                        ...
                                        <?php else: ?>
                                            ...
                                            <div>
                                                <ul class="list-unstyled  spaced">
                                                    <li>
                                                        <i class="ace-icon fa fa-caret-right green"></i><?php echo $receiveVoucher->miscellaneous; ?>
                                                    </li>
                                                </ul>
                                            </div>
