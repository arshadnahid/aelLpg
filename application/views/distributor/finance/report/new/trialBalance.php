...
//                                                 $total_pvscredit += $total_opencredit;
                                            ...
                                            if ($row_cma->chartId == 58) {
                                                ...
                                                $total_pvsdebit += $total_opendebit + $customerOpening;
                                            }
                                    ...
                                    foreach ($row_cta['Accountledger'] as $row_cma):
                                        ...
                                        <tr>
                                            ...
                                            endforeach;
                                             ...
                                             if ($row_cma->chartId == 50) {
                                                $total_pvsdebit += $total_opendebit+$supplierOpening;
                                            }
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td align="right"><strong><?php echo number_format((float) $sub_total_credit + $totalRetainEarnig, 2, '.', ','); ?></strong></td>
