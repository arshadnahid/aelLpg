    ...
    <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state noPrint" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">Payment Voucher View</li>
            </ul>


            <ul class="breadcrumb pull-right">
                <li>
                    <a href="<?php echo site_url('paymentVoucher'); ?>">
                ...
                <li>
                    <a class="financeEditPermission" href="<?php echo site_url('paymentVoucherEdit/' . $paymentVoucher->generals_id); ?>">
                    ...
                    <div class="widget-box transparent">
                        <div class="widget-header widget-header-large">
                            ...
                            <div class="widget-toolbar no-border invoice-info">
                                ...
                                <span class="red"><?php echo $paymentVoucher->voucher_no; ?></span>

                                <br />
                                <span class="invoice-info-label">Date:</span>
                                <span class="blue"><?php echo $paymentVoucher->date ?></span>
                            </div>
