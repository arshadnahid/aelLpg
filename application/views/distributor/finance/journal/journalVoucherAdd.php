        ...
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            ...
            <ul class="breadcrumb pull-right">
                <li class="active">
                    ...
                    <a title="Journal Voucher List" href="<?php echo site_url('journalVoucher'); ?>">List</a>
                </li>
            </ul>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group">
                                        <input class="form-control date-picker" name="date" id="journalDate" type="text" value="<?php echo date('d-m-Y'); ?>" data-date-format="dd-mm-yyyy" />
