        ...
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
                <li>
                    ...
                    <a href="<?php echo site_url('DistributorDashboard/1'); ?>">Journal</a>
                </li>
            ...
            <ul class="breadcrumb pull-right">
                <li class="active">
                    ...
                    <a href="<?php echo site_url('journalVoucher'); ?>">List</a>
                </li>
                <li class="active financeAddPermission"><a href="<?php echo site_url('journalVoucherAdd'); ?>" >
                        <i class="ace-icon 	fa fa-plus"></i>  Add
                    </a>
                </li>
                <li class="active"><a href="<?php echo site_url('journalVoucherView/' . $journalVoucher->generals_id); ?>" >
                    ...
                    <form id="publicForm" action=""  method="post" class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group">
                                        <input class="form-control date-picker" name="date" id="id-date-picker-1" type="text" value="<?php echo date('d-m-Y', strtotime($journalVoucher->date)); ?>" data-date-format="dd-mm-yyyy" />
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" id="form-field-1" name="voucherid" readonly value="<?php echo $journalVoucher->voucher_no; ?>" class="form-control" placeholder="Voucher Id Code" />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-10 col-md-offset-1">
                            ...
                            <table class="table table-bordered table-hover" id="show_item">
                                <thead>
                                    <tr>
                                        <td style="width:35%"  align="center"><strong>Account Head<span style="color:red;"> *</span></strong></td>
                                        <td style="width:15%" align="center"><strong>Debit<span style="color:red;"> *</span></strong></td>
                                        <td style="width:15%" align="center"><strong>Credit<span style="color:red;"> *</span></strong></td>
                                ...
                                <tbody>
                                    ...
                                    foreach ($generalledger as $key => $eachAccount):
                                        $totalDebit+=$eachAccount->debit;
                                        $totalCredit+=$eachAccount->credit;
                                        $chartInfo = $this->Common_model->tableRow('chartofaccount', 'chart_id', $eachAccount->account);
                                        ?>

                                        <tr class="new_item<?php echo $key + 678 ?>">
                                            <td style="padding-left:15px;"><?php echo $chartInfo->title . ' [ ' . $chartInfo->accountCode . ' ]'; ?><input type="hidden" name="account[]" value="<?php echo $eachAccount->account; ?>"></td>
                                            <td style="padding-left:15px;" align="right"><input id="debitId_<?php echo $key+678;?>"  onblur="checkInputValue(this.value)" class="amountDr  text-right form-control" type="text" name="amountDr[]"  <?php
                                    if (empty($eachAccount->debit) || $eachAccount->debit <= 0) {
                                        echo "readonly";
                                    }
                                        ?> value="<?php echo $eachAccount->debit; ?>"></td>
                                            <td style="padding-left:15px;" align="right">
                                                <input class="amountCr  text-right form-control" id="creditId_<?php echo $key+678;?>" onblur="checkInputValue(this.value)" type="text" name="amountCr[]" <?php
                                                                                            if (empty($eachAccount->debit) || $eachAccount->credit <= 0) {
                                                                                                echo "readonly";
                                                                                            }
                                        ?> value="<?php echo $eachAccount->credit; ?>"></td>
                                            <td align="right"><input type="text" class="add_quantity text-right form-control" name="memo[]" value="<?php echo $eachAccount->memo; ?>"></td>
                                            <td><a del_id="<?php echo $key + 678 ?>" class="delete_item btn form-control btn-danger" href="javascript:;" title=""><i class="fa fa-times"></i>&nbsp;Remove</a></td>
                                        </tr>
                                ...
                                <tfoot>
                                    <tr>
                                        <td>
                                            <select   class="chosen-select form-control accountId" id="form-field-select-3" data-placeholder="Search by account head"  onchange="check_pretty_cash(this.value)">
                                        ...
                                        <td><input type="text" class="form-control text-right amountDrValue" onblur="checkInputValue(this.value)" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"  placeholder="0.00"></td>
                                        <td><input type="text" class="form-control text-right amountCrValue" onblur="checkInputValue(this.value)"  oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"  placeholder="0.00"></td>
                                    ...
                                    <tr>
                                        ...
                                        <td align="right"><strong class="total_dr"><?php echo $totalDebit . '.00'; ?></strong></td>
                                        <td align="right"><strong class="total_cr"><?php echo $totalCredit . '.00'; ?></strong></td>
                        ...
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        <textarea cols="100" rows="2" name="narration" placeholder="Narration" type="text"><?php echo $journalVoucher->narration; ?></textarea>
