        ...
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
                <li>
                    ...
                    <a href="<?php echo site_url('DistributorDashboard/2'); ?>">Setup</a>
                </li>
                <li class="active">Incentive List</li>
            </ul>
            <ul class="breadcrumb pull-right">
                <li>
                    <a class=" green" data-toggle="modal" data-target="#myModal" href="#">
                        ...
                        <tbody>
                            <?php foreach ($incentiveList as $key => $eachIncentive): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a class="blue" href="<?php site_url('brandEdit/' . $eachIncentive->incentive_id) ?>">
                                            <i class="ace-icon fa fa-pencil bigger-130"></i>
                                        </a>
                                        <a class="red inventoryDeletePermission" href="javascript:void(0)" onclick="deleteBrand('<?php echo site_url($eachIncentive->incentive_id);?>')">
