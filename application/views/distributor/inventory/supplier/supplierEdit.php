    ...
    <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            ...
            <ul class="breadcrumb pull-right">
                <li>
                    <a href="<?php echo site_url('supplierList'); ?>">
                ...
                <div class="col-md-12">
                    <form id="publicForm" action=""  method="post" class="form-horizontal">
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Supplier ID <span style="color:red;"> * </span> </label>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Supplier Name <span style="color:red;"> * </span> </label>
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Phone<span style="color:red;"> * </span> </label>
                            <div class="col-sm-6">
                        ...
                        <?php if (!empty($supplierEdit->supLogo)): ?>
                                                                            <img class="img-thumbnail" width="90" height="64" src="<?php
                        if (!empty($supplierEdit->supLogo)) {
                            echo site_url('uploads/thumb/' . $supplierEdit->supLogo);
                        }
                            ?>" border="0">
                        <?php else: ?>
