<div class="main-content">
    <div class="main-content-inner">
        ...
        <div class="page-content">
            <div class="row">
                <div class="col-md-12">
                    <form id="publicForm" action="<?php echo site_url('Supplier'); ?>"  method="post" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" id="form-field-1" name="supName" class="form-control required" placeholder="Name" required/>
                            </div>
                        </div>
