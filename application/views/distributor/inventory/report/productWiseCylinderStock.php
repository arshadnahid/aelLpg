...
//----------------------------------------------------------------------------------
                                        ...
                                        $this->db->select("sum(quantity) as exchangOpIn");
                                        $this->db->where('dist_id', $dist_id);
                                        $this->db->where('type', 'Cin');
                                        $this->db->where('product_id', $eachProduct->product_id);
                                        ...
                                        $this->db->where('category_id', 2);
                                        $this->db->where('date <', $from_date);
                                        $exchangOpIn = $this->db->get('stock')->row();

                                        $this->db->select("sum(quantity) as exchangOpOut");
                                        $this->db->where('dist_id', $dist_id);
                                        $this->db->where('type', 'Cout');
                                        $this->db->where('product_id', $eachProduct->product_id);
                                        $this->db->where('form_id', 27);
                                        $this->db->where('category_id', 2);
                                        $this->db->where('date <', $from_date);
                                        $exchangOpOut = $this->db->get('stock')->row();
...
//---------------------------------------------------------------------------------
                                        ...
                                        $this->db->select("sum(quantity) as exchangCuIn");
                                        $this->db->where('dist_id', $dist_id);
                                        $this->db->where('type', 'Cin');
                                        $this->db->where('category_id', 2);
                                        $this->db->where('product_id', $eachProduct->product_id);
                                        ...
                                        $this->db->where('date >=', $from_date);
                                        $this->db->where('date <=', $to_date);
                                        $exchangCuIn = $this->db->get('stock')->row();

                                        $this->db->select("sum(quantity) as exchangeCuOut");
                                        $this->db->where('dist_id', $dist_id);
                                        $this->db->where('type', 'Cout');
                                        $this->db->where('category_id', 2);
                                        $this->db->where('product_id', $eachProduct->product_id);
                                        ...
                                        $this->db->where('date <=', $to_date);
                                        $this->db->order_by('stock_id', 'asc');
                                        $exchangeCuOut = $this->db->get('stock')->row();
//---------------------------------------------------------------------

                                        $copBalance = ($purchasesOpIn->tPurOpIn + $saleOpIn->tSalOpIn + $mainOpQuanity + $exchangOpIn->exchangOpIn) - ($purchasesOpOut->tPurOpOut + $saleOpOut->tSalOpOut + $exchangOpOut->exchangOpOut);
                                        $currentIn = $purchasesIn->tPurIn + $saleIn->tSalIn + $exchangCuIn->exchangCuIn;
                                        $currentOut = $purchasesOut->tPurOut + $saleCuOut->tSalOut + $exchangeCuOut->exchangeCuOut;
...
//---------------------------------------------------------------------------------
                                ...
                                $this->db->where('date >=', $from_date);
                                $this->db->where('date <=', $to_date);
                                $exCuIn = $this->db->get('stock')->result_array();
                                ...
                                $this->db->where('date <=', $to_date);
                                $this->db->order_by('stock_id', 'asc');
                                $exCuOut = $this->db->get('stock')->result_array();



                                $totalInout = array_merge($purchasesIn, $saleIn, $purchasesOut, $saleCuOut, $exCuIn, $exCuOut);
                                $copBalance = ($purchasesOpIn->tPurOpIn + $saleOpIn->tSalOpIn + $mainOpQuanity + $exchangOpIn->exchangOpIn) - ($purchasesOpOut->tPurOpOut + $saleOpOut->tSalOpOut + $exchangOpOut->exchangOpOut);
                                ?>
                                <thead>
                                    <tr>
