    ...
    <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state  noPrint" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">Cylinder Details Report</li>
            </ul>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <select style=""  onchange="selectPayType(this.value)" class="form-control"  id="type_id" name="type_id"   data-placeholder="Select Type">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="col-md-3 control-label no-padding-right" for="form-field-1">Balance Type</label>
                                                    <div class="col-md-9">
                                                        <select style=""   class="form-control"  id="balance_type" name="balance_type"   data-placeholder="Select Type">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="col-md-3 control-label no-padding-right" for="sub_cus_id" id="sub_cus_label" >Customer Id</label>
                                                    <div class="col-md-9">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-5">
                                                        <div class="form-group">
                                                            <label class="col-md-3 " for="form-field-1"> From </label>
                                                            <div class="col-md-8">
