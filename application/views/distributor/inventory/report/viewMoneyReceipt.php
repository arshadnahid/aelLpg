    ...
    <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state noPrint" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">Supplier Payment Money Receipt</li>
            </ul>
                                ...
                                <div class="row"  >
                                    ...
                                    <div class="col-xs-6">
                                        ...
                                        <div>
                                            <ul class="list-unstyled  spaced">
                                                <li>
                                                    <i class="ace-icon fa fa-caret-right green"></i><?php echo $suplierInfo->supID . '[' . $suplierInfo->supName . ']' ?>
                                                </li>

                                                <li>
                                                    <i class="ace-icon fa fa-caret-right green"></i><?php echo $suplierInfo->supEmail; ?>
                                                </li>

                                                <li>
                                                    <i class="ace-icon fa fa-caret-right green"></i><?php echo $suplierInfo->supPhone; ?>
                                                </li>
                                                <li>
                                                    <i class="ace-icon fa fa-caret-right green"></i><?php echo $suplierInfo->supAddress; ?>
                                                </li>
                                        ...
                                        <tr>
                                            ...
                                            <td  nowrap class="receiveby"  id="receiveby">
                                                ...
                                                if (empty($invoiceinfo)) {
                                                    echo $moneyReceitInfo->invoiceID;
                                                } else {
