    ...
    <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            ...
            <ul class="breadcrumb pull-right">
                <li>
                    <a href="<?php echo site_url('inventoryAdjustment'); ?>">
                    ...
                    <form id="publicForm" action=""  method="post" class="form-horizontal">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Adjustment ID</label>
                                <div class="col-sm-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Adjustment Date</label>
                                <div class="col-sm-6">
                                ...
                                <tfoot>
                                    <tr>
                                        <td>
                                            ...
                                            <select id="category_product"  onchange="getProductList(this.value)" class="chosen-select form-control" id="form-field-select-3" data-placeholder="Search by product Cat">
                                                <option value=""></option>
                                                <?php
