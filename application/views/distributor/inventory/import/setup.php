            ...
            <div class="row">
                <div class="col-md-12">
                    <form id="publicForm" action=""  method="post" class="form-horizontal" enctype="multipart/form-data">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Customer CSV File</label>
                                <div class="col-sm-6">
                                ...
                                <a type="button" class="btn btn-xs btn-success" href="<?php echo base_url() ?>excelfiles/customer.csv"> <i class="fa fa-cloud-download"></i> &nbsp;Download CSV Format</a>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                    </form>
            ...
            <div class="row">
                <div class="col-md-12">
                    <form id="publicForm" action=""  method="post" class="form-horizontal" enctype="multipart/form-data">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Unit CSV File</label>
                                <div class="col-sm-6">
                                    <input type="file" id="form-field-1" name="UnitImport"  value="" class="form-control"  />
                                </div>
                                <button onclick="return isconfirm()" id="subBtn" class="btn btn-xs btn-info" type="submit">
                                    <i class="ace-icon fa fa-check bigger-110"></i>
                                    Save
                                ...
                                <a type="button" class="btn btn-xs btn-success" href="<?php echo base_url() ?>excelfiles/unit.csv"><i class="fa fa-cloud-download"></i> &nbsp; Download CSV Format</a>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                    </form>
            ...
            <div class="row">
                <div class="col-md-12">
                    <form id="publicForm" action=""  method="post" class="form-horizontal" enctype="multipart/form-data">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Reference CSV File</label>
                                <div class="col-sm-6">
                                    <input type="file" id="form-field-1" name="referenceImport"  value="" class="form-control"  />
                                </div>
                                <button onclick="return isconfirm()" id="subBtn" class="btn btn-xs btn-info" type="submit">
                                    <i class="ace-icon fa fa-check bigger-110"></i>
                                    Save
                                ...
                                <a type="button" class="btn btn-xs btn-success" href="<?php echo base_url() ?>excelfiles/reference.csv"> <i class="fa fa-cloud-download"></i> &nbsp; Download CSV Format</a>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                    </form>
