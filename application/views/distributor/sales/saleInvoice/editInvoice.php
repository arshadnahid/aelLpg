...
<div class="main-content">
    <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
                <li>
                    <i class="ace-icon fa fa-truck home-icon"></i>
            ...
            <ul class="breadcrumb pull-right">
                ...
                <li>
                    <a class=""  href="<?php echo site_url('salesInvoice_view/' . $editInvoice->generals_id); ?>">
                        <i class="ace-icon fa fa-search-plus bigger-130"></i> View
                    </a>
                </li>
                <li>
                    <a class="saleEditPermission"  href="<?php echo site_url('salesInvoicViewWithCylinder/' . $editInvoice->generals_id); ?>">
