...
function supplierStatusChange(supID,supStatus){
    ...
    function (isConfirm) {
        if (isConfirm) {
            ...
            var base_u = $('#baseUrl').val();
            var main_url = base_u +'SetupController/suplierStatusChange';
            $.ajax({
                url: main_url,
                type: 'post',
                data: {
...
function customerStatusChange(supID,supStatus){
    ...
    function (isConfirm) {
        if (isConfirm) {
            ...
            var base_u = $('#baseUrl').val();
            var main_url = base_u +'SetupController/customerStatusChange';
            $.ajax({
                url: main_url,
                type: 'post',
                data: {
...
function userStatusChange(userId,status){
    ...
    function (isConfirm) {
        if (isConfirm) {
            ...
            var base_u = $('#baseUrl').val();
            var main_url = base_u +'SetupController/userStatusChange';
            $.ajax({
                url: main_url,
                type: 'post',
                data: {
                ...
                success: function(data) {
                    ...
                    if(data == 1){
                        window.location.replace(base_u +"userList");
                    }
                }
            });
...
function productStatusChange(productid,supStatus){
    ...
    function (isConfirm) {
        if (isConfirm) {
            ...
            var base_u = $('#baseUrl').val();
            var main_url = base_u +'SetupController/productStatusChange';
            $.ajax({
                url: main_url,
                type: 'post',
                data: {
