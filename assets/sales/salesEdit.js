...
$(document).ready(function () {
    ...
    $("#add_item").click(function () {
        ...
        if(productCatID  == ''){
            ...
            if(productCatID == 2){
                $("#show_item tfoot").append('<tr class="new_item' + productCatID + productID + j + '"><input type="hidden" name="category_id[]" value="' + productCatID + '"><td style="padding-left:15px;">[ ' + productCatName + '] - ' + productName + '<input type="hidden"  name="product_id[]" value="' + productID + '"></td><td align="right"><input type="text" class="add_quantity decimal text-right form-control" name="quantity[]" value="' + quantity + '"  id="qty_'+ j +'"></td><td align="right"><input type="text" class="add_ReturnQuantity decimal text-right form-control" name="returnQuantity[]" value="' + returnQuantity + '"  id="returnAble_'+ j +'"></td><td align="right"><input type="text" class="add_rate  text-right form-control decimal" name="rate[]" value="' + rate + '"  id="rate_'+ j +'"></td><td align="right"><input type="text" class="add_price  text-right form-control" readonly name="price[]" value="' + price + '"  id="tprice_'+ j +'"></td><td><a del_id="' + productCatID + productID  + j + '" class="delete_item btn form-control btn-danger" href="javascript:;" title=""><i class="fa fa-times"></i>&nbsp;Remove</a></td></tr>');
            }else{

                $("#show_item tfoot").append('<tr class="new_item' + productCatID + productID + j + '"><input type="hidden" name="category_id[]" value="' + productCatID + '"><td style="padding-left:15px;">[ ' + productCatName + '] - ' + productName + '<input type="hidden"  name="product_id[]" value="' + productID + '"></td><td align="right"><input type="text" class="add_quantity  decimal text-right form-control" name="quantity[]" value="' + quantity + '"  id="qty_'+ j +'"></td><td align="right"><input type="text" class="add_ReturnQuantity decimal text-right form-control" readonly name="returnQuantity[]" value="' + returnQuantity + '"  id="returnAble_'+ j +'"></td><td align="right"><input type="text" class="add_rate  text-right form-control decimal" name="rate[]" value="' + rate + '"  id="rate_'+ j +'"></td><td align="right"><input type="text" class="add_price  text-right form-control" readonly name="price[]" value="' + price + '"  id="tprice_'+ j +'"></td><td><a del_id="' + productCatID + productID  + j + '" class="delete_item btn form-control btn-danger" href="javascript:;" title=""><i class="fa fa-times"></i>&nbsp;Remove</a></td></tr>');
            }
            j++;
        }
        $("#subBtn").attr('disabled',false);
